	...
	<div id="sidebar_nav" class="hidden-xs">
		...
		<div class="media">
		  <div class="media-left">
		    <a href="#">
		      <img class="media-object img-circle" src="<?php echo URL;?>/app/view/dashboard/asset/img/face-1.jpg" alt="profile picture">
		    </a>
		  </div>
		  <div class="media-body">
		    <h5 class="media-heading">Welcome, <?php echo $display_name;?></h5>
		    <div id="icon_bar">
		    	<a href="<?php echo URL;?>login"><i class="fa fa-power-off" title="Logout" style="color: #d9534f;"></i></a>
	...
	<section id="main_area">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-12">
					<h3><i class="fa fa-thumb-tack"></i> Post |<small> manage your posts</small></h3>
				</div>
				</div>
					...
					<div class="panel panel-default">
					  ...
					  <div class="panel-body">
					    <div class="row">
					    	...
					    	<a href="<?php echo URL?>dashboard/render_add_post" class="btn btn-default btn-xs pull-left">Add Post</a>
					    	...
					    	<tbody>
					    		<?php foreach ($this->all_post as $post) {?>
					    		<tr>
					    			<td><?php echo $post['title'];?></td>
					    			<?php if($post['enabled']  == 1) {
					    				echo "<td><span class='fa fa-check' aria-hidden='true'></span></td>";
					    			} else {
					    				echo "<td><span class='fa fa-remove' aria-hidden='true'></span></td>";
					    			} ?>
					    			<td><?php echo $post['date_published'];?></td>
					    			<td>
					    				<a class="btn btn-default btn-xs" title="Edit Post" href="<?php echo URL;?>dashboard/render_edit_post?pe_id=<?php echo htmlspecialchars($post['id'])?>"><i class="fa fa-edit"></i> </a>
					    				<a class="btn btn-danger btn-xs" title="Delete Post" href="<?php echo URL;?>dashboard/delete_post?pd_id=<?php echo htmlspecialchars($post['id'])?>"><i class="fa fa-remove"></i></a>
					    			</td>
					    		</tr>
								<?php } ?>
					    	</tbody>
