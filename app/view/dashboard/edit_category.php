	...
	<section id="main_area">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-12">
					<h3><i class="fa fa-folder"></i> Category |<small> manage your site categories</small></h3>
				</div>
				</div>
				...
				<div class="panel panel-default">
				  <div class="panel-body">
				  	<h4>Category</h4>
				    <form action="<?php echo URL;?>dashboard/add_edit_category?e_id=<?php echo $this->selected_category['id']?>" method="post">
					  <div class="form-group">
					  	<label for="category_title">Title</label>
					    <input type="text" class="form-control" id="category_title" value="<?php echo $this->selected_category['category'];?>" name="ce_title" required/>
					  </div>
					  <div class="form-group">
					  <label for="category_description">Description</label>
					  <textarea class="form-control" rows="4" id="category_description" name="ce_description" optional><?php echo $this->selected_category['description'];?></textarea>
					  </div>
					  <button type="submit" class="btn btn-info btn-xs">Update Category</button>
					</form>
					<hr />
					<p>Describing categories make for better use</p>
				  </div>
				</div>
				</div>
					    ...
					    <div class="row">
					    	...
					    	<tbody>
								...
								<tr>
					    			...
					    			<td>
					    				<a class="btn btn-default btn-xs" title="Edit Category" href="<?php echo URL;?>dashboard/render_edit_category?ce_id=<?php echo $category['id'];?>"><i class="fa fa-edit"></i> </a> 
					    				<a class="btn btn-danger btn-xs" title="Delete Category" href="<?php echo URL;?>dashboard/delete_category?cd_id=<?php echo $category['id'];?>"><i class="fa fa-remove"></i></a>
					    			</td>
					    		</tr>
								<?php } ?>
					    	</tbody>
