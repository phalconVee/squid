			...
			<div class="row">
				...
				<div class="panel panel-default">
				  <div class="panel-body">
				  	<h4>Quick Drafts</h4>
				    <form action="<?php echo URL;?>dashboard/add_draft" method="post">
					  <div class="form-group">
					    <label for="draft_title">Title</label>
					    <input type="text" class="form-control" id="draft_title" placeholder="Draft Title" name="d_title" required>
					  </div>
					  <div class="form-group">
					  <label for="draft_content">What's on your mind?</label>
					  <textarea class="form-control" rows="4" id="draft_content" placeholder="Draft Content" name="d_article" required></textarea>
					  </div>
				  ...
				  <div class="panel-body">
				    ...
				    <div class="row" id="glace_notification_icon">
                    	<div class="col-md-4">
                    		...
                    		<a href="#"><h5><?php echo $this->count_post; ?> Posts</h5></a>
                    	</div>
                    	<div class="col-md-4">
		                ...
		                <div class="table-full-width table_comment">
	                        <table class="table">
	                            <tbody>
	                                <tr>
	                                    <td class="col-md-2">
	                                        <img src="<?php echo URL;?>/app/view/dashboard/asset/img/default-avatar.png" class="img-responsive img-thumbnail" />
	                                    </td>
