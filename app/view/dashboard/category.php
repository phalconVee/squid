			...
			<div class="row">
				...
				<div class="panel panel-default">
				  <div class="panel-body">
				  	<h4>Category</h4>
				    <form action="<?php echo URL;?>dashboard/add_category" method="post">
					  <div class="form-group">
					  	<label for="category_title">Title</label>
					    <input type="text" class="form-control" id="category_title" placeholder="create a category" name="c_title" required/>
					  </div>
					  <div class="form-group">
					  <label for="category_description">Description</label>
					  <textarea class="form-control" rows="4" id="category_description" placeholder="category description" name="c_description" optional></textarea>
					  </div>
					  <button type="submit" class="btn btn-info btn-xs">Save Category</button>
					</form>
					<hr />
