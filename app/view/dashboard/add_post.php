	...
	<section id="main_area">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-12">
					<h3><i class="fa fa-thumb-tack"></i> Post |<small> Add new post</small></h3>
				</div>
				</div>
				<!--add post form-->
				<div class="col-md-8">
					...
					<div class="panel panel-default" id="add_post">
					  ...
					  <div class="panel-body">
					  	<form action="<?php echo URL;?>dashboard/add_new_post" method="post">
					      <div class="form-group">
							  <label>Title</label>
							  <input type="text" class="form-control" name="p_title" placeholder="Page Title" aria-describedby="basic-addon1" required />
							</div>
							
							<div class="form-group">
							  <label>Content</label>
							  <textarea name="p_article" id="editor1" class="form-control" rows="12" optional></textarea>
							</div>
							
							<div class="checkbox">
							  <label>
								<input type="checkbox" checked value="1" name="p_enabled"/> Published
							  </label>
							</div>
							
							<input type="submit" class="btn btn-info btn-xs" value="Publish"/>
					  </div>
					</div>	
						...
						<!--accordion for category information-->  
						    ...
						    <div id="collapse_category" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_category">
						      <div class="panel-body">
								...
								<div class="tab-content clearfix">
									...
									<ul id="tag_list">
							    		<?php foreach ($this->most_used_category as $most_used_category) {?>
										<li>
					    					<div class="checkbox">
											  <label>
												<input type="checkbox" value="<?php echo $most_used_category['id'];?>"/> <?php echo $most_used_category['category'];?></td>
											  </label>
											</div>
							    		</li>
										<?php }?>
								...
								<hr />
								<a href="<?php echo URL;?>dashboard/render_category">+Add New Category</a>
						      </div>
						  ...
						  <div class="panel panel-default">
						    ...
						    <div id="collapse_tag" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_tag">
						      <div class="panel-body">
								 <form action="<?php echo URL;?>dashboard/add_tag" method="post" >
								  <div class="form-group">
								   <label for="category_title">Title</label>
								    <input type="text" class="form-control" name="t_title" />
								  </div>
								  <button type="submit" class="btn btn-info btn-xs">Save Tag</button>
								</form>
								   <hr />
						          ...
						          <div>
							    	<ul id="tag_list">
										...
										<li>
					    					<div class="checkbox">
											  <label>
												<input type="checkbox" value="<?php echo $tag['tag'];?>"/> <?php echo $tag['tag'];?></td>
											  </label>
											</div>
							    		</li>
										<?php }?>
