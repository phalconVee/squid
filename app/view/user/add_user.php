	...
	<section id="main_area">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-12">
					<h3><i class="fa fa-users"></i> User |<small> Add User</small></h3>
				</div>
				</div>
					  ...
					  <div class="panel-body">
					    <div class="row">
					    	<div class="col-md-9">
					    		...
					    		<form class="form-horizontal" action="<?php echo URL;?>user/add_new_user" method="post">
									  <div class="form-group">
									    <label for="input_username" class="col-sm-3 control-label">Username <i>(Required)</i></label>
									    <div class="col-sm-6">
									      <input type="text" class="form-control" id="input_username" placeholder="Username" name="u_username" required/>
									    </div>
									  </div>
									  <div class="form-group">
									    <label for="input_display_name" class="col-sm-3 control-label">Display Name <i>(Required)</i></label>
									    <div class="col-sm-6">
									      <input type="text" class="form-control" id="input_display_name" placeholder="Display Name" name="u_displayname"  required/>
									    </div>
									  </div>
									  <div class="form-group">
									    <label for="inputPassword3" class="col-sm-3 control-label">Password <i>(Required)</i></label>
									    <div class="col-sm-6">
									      <input type="text" class="form-control" id="inputPassword3" placeholder="Password" name="u_password" required>
									    </div>
									  </div>
									  <div class="form-group">
									  ...
									  <div class="form-group">
									    <div class="col-sm-offset-2 col-sm-6">
									      <button type="submit" class="btn btn-info btn-xs">Add new user</button>
									    </div>
									  </div>
								</form>
					    	</div>
